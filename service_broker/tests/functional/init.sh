...
${UTILS}/canonize_internal_api.py ${WORK_DIR}/API/deps ${MAIN_SERVICE_NAME}/service-broker
...
wait_for_unavailable_services ${SHARED_API_DIR} "${MAIN_SERVICE_NAME}/service-broker" ANY_SERVICE_UNAVAILABLE_COUNT
