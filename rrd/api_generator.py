...
def make_script_rrd_collect(script, desired_file_ext=""):
    ...
    body = (
        ...
        *api_fs_exec_utils.generate_bypassed_params_formatting(), r"",
        ...
        api_fs_bash_utils.add_suffix_if_exist()[0] + " \"${SESSION_ID_VALUE}\" \"result\" MULTISESSION_PIPE_OUT_RRD", r"",
        *api_fs_exec_utils.generate_read_api_fs_args(), r"",
        r'echo ${IN_ARGS[@]} > ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/rrd/PUT/exec',
        api_fs_bash_utils.wait_until_pipe_exist()[0] + " ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/rrd/PUT/${MULTISESSION_PIPE_OUT_RRD}",
        ...
        api_fs_bash_utils.wait_until_pipe_exist()[0] + " ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/PUT/${MULTISESSION_PIPE_OUT_RRD}",
        r'ONLY_METRICS_IN_RANGE=`cat ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/PUT/${MULTISESSION_PIPE_OUT_RRD}`',
        r'if [ ! -z ${SESSION_ID_VALUE} ]; then echo "SESSION_ID=`hostname`${SESSION_ID_VALUE} $(replace_space_in_even_position \"${ONLY_METRICS_IN_RANGE}\")" > ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/statistic/GET/exec; fi',
        ...
        api_fs_bash_utils.add_suffix_if_exist()[0] + " \"${SESSION_ID_VALUE}\" \"result.xml_`hostname`\" MULTISESSION_PIPE_OUT_STATISTIC", r"",
        api_fs_bash_utils.wait_until_pipe_exist()[0] + " ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/statistic/GET/${MULTISESSION_PIPE_OUT_STATISTIC}",
...
def make_script_rrd_view(script, desired_file_ext=""):
    ...
    body = (
        ...
        *api_fs_exec_utils.generate_read_api_fs_args(), r"",
        ...
        api_fs_bash_utils.wait_until_pipe_exist()[0] + " ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/rrd/select/GET/${MULTISESSION_PIPE_OUT}",
