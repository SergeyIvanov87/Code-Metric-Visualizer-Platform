...
def make_script_rrd_collect(script, desired_file_ext=""):
    ...
    body = (
        ...
        *api_fs_exec_utils.generate_read_api_fs_args(), r"",
        ...
        r'RRD_DB_PARAMS=`cat ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/rrd/PUT/result`',
...
def make_script_rrd_view(script, desired_file_ext=""):
    ...
    body = (
        ...
        *api_fs_exec_utils.generate_api_node_env_init(), r"",
        ...
        r'cat ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/rrd/select/GET/result.txt | ${WORK_DIR}/fetch_rrd.py ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/rrd/select/view',
    )
    script.writelines(line + "\n" for line in body)
...
def make_script_rrd_plot_view(script, desired_file_ext=""):
    ...
    body = (
        ...
        *api_fs_exec_utils.generate_api_node_env_init(), r"",
        ...
        r'echo "${IN_ARGS[@]}" > ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/rrd/select/GET/exec',
        r'cat ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/rrd/select/GET/result.txt | ${WORK_DIR}/graph_rrd.py ${SHARED_API_DIR}/${MAIN_SERVICE_NAME}/cc/analytic/rrd/select/plot_view ${RESULT_FILE}',
