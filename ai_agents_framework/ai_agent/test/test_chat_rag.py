...
def execute_api(
    ...
    # The service owns the session result pipe and removes it after responding.
    # Removing it in the client races with that cleanup and makes wait_result fail.
