...
analytic	PUT	api.pmccabe_collector.restapi.org/project/{uuid}/analytic	--start=1701154260	--step=1	NO_NAME_PARAM.0=DS:mmcc:GAUGE:1y:U:U	NO_NAME_PARAM.1=RRA:LAST:0.1:1:100000
